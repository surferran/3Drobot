...
static const int  NUM_OF_FEATURES = 400; //400
static const int  winFactor =  2;//5;
...
int do_example_for_optical_flow(void)
{
	...
	cv::resizeWindow("Optical Flow", frame_size.width/ winFactor, frame_size.height/ winFactor);
